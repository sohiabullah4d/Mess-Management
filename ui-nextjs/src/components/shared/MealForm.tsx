...
export const MealForm: React.FC<MealFormProps> = ({ meal, onSubmit }) => {
          ...
          <Box sx={{ display: "flex", gap: 2, alignItems: "flex-end", mb: 2 }}>
            ...
            <TextField
              ...
              onChange={(e) =>
                setNewItem({
                  ...newItem,
                  usagePerPerson: parseFloat(e.target.value) || 0,
                })
              }
            ...
            <IconButton
              onClick={addItem}
              color="primary"
              disabled={!newItem.itemId || newItem.usagePerPerson <= 0}
            >
              <Add />
            </IconButton>
          </Box>
